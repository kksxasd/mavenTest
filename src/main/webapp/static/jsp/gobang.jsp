...
<head>
    ...
    <script type="text/javascript">
        ...
        var img_b = new Image();
        img_b.src = "/static/image/gobang/b.jpg";//白棋图片
        var img_w = new Image();
        img_w.src = "/static/image/gobang/w.jpg";//黑棋图片
        ...
        function play(e) {//鼠标点击时发生
            var leftWidth=$("#canvas").offset().left;
            var x = parseInt((e.clientX -leftWidth- 20) / 40);//计算鼠标点击的区域，如果点击了（65，65），那么就是点击了（1，1）的位置
...
<div id="fh5co-page">
    ...
    <div id="fh5co-main">
        <canvas width="640" id="canvas" onmousedown="play(event)" height="640">你的浏览器不支持HTML5 canvas ，请使用 google
            chrome 浏览器 打开.
        </canvas>
    </div>
